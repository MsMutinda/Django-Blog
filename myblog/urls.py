...
from .views import HomeView, PostDetailView, AddPostView, LikePost, EditPostView, DeletePostView, AddCategoryView, \
...
urlpatterns = [
    ...
    path('post/<int:pk>/like', LikePost, name="like_post"),
